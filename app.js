...
saveNoteButton.addEventListener("click", function () {
  ...
  // condition checking over allNotes(stringified array from locastorage)
  if (allNotes === null) {
    notesArray = [];
  } else {
  ...
  // creation of single note with the help of NoteTemplate class:
  const singleNote = new NoteTemplate(title, body);

  // condition over single note element:
...
const showNotes = () => {
  ...
  if (allNotes === null) {
    ...
    notesArray = JSON.parse(allNotes);
    // condition checking over notesArray(parsed from localstorage)
